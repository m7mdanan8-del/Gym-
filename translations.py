...
DAY_FOCUS_AR = {
    "Monday":    "قوة الجزء السفلي — تركيز الرباعية والرباط الصليبي",
    "Tuesday":   "قوة الجزء العلوي — تركيز تأهيل الكتف",
    "Wednesday": "السلسلة الخلفية — أوتار الركبة والمقعدة والتوازن",
    "Thursday":  "وظيفي لكامل الجسم — الجذع وتحضير كرة القدم",
    "Friday":    "يوم استشفاء",
...
WEEK_THEMES_AR = {
    1: ("التأسيس",
        "أتقن كل نمط حركي بشدة مريحة (RPE 5-6). التمارين الثابتة والإيقاع "
        "المتحكم فيه يعيدان تنشيط الرباعية والكفة المدورة. لا شيء يجب أن "
        "يكون صعبًا بعد — هذا مقصود."),
    2: ("التدرج",
        "نفس الأهداف مع حمل أكبر (RPE 6-7). يدخل النورديك ودفع الورك والضغط "
        "الأرضي. أضف زيادات صغيرة فقط حيث كانت الجولة الأخيرة الأسبوع "
        "الماضي تحت السيطرة."),
    3: ("التدرج المتقدم",
        "تركيز على الرجل الواحدة، إطالات بطيئة، وأول قفزات الهبوط والتثبيت "
        "(RPE 7-8). تظهر وضعية 90/90 للكتف — فقط إذا كانت تمارين الكفة في "
        "الأسبوعين ١-٢ بلا ألم."),
    4: ("التنويع + التقييم",
        "تنويعات جديدة بحمل متوسط مع اختبارات مرجعية: ثبات الحائط، تكرارات "
        "السمانة، البلانك، اتزان Y، واختبار القفز على رجل واحدة (إذا كان بلا "
        "ألم). الأرقام التي تسجلها توجه الشهر القادم."),
}
