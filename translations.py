...
DAY_FOCUS_AR = {
    "Monday":    "قوة وانفجارية الجزء السفلي — تركيز الرباعية",
    "Tuesday":   "بناء الجزء العلوي والكتفين",
    "Wednesday": "السلسلة الخلفية — أوتار الركبة والمقعدة والتوازن",
    "Thursday":  "السرعة والقوة الانفجارية وتحضير كرة القدم",
    "Friday":    "يوم استشفاء",
...
WEEK_THEMES_AR = {
    1: ("التحميل المتقدم",
        "أنماط ثقيلة جديدة تدخل: السكوات الأمامي، ضغط الكتف بالدمبل، "
        "العقلة، القفز على الصندوق وانطلاقات العدو. الأوزان أخف بدرجة "
        "واحدة (RPE 7) حتى تُتقن الحركات الجديدة — أضف وزنًا فقط حيث "
        "يكون الأداء متقنًا."),
    2: ("زيادة الحمل",
        "نفس الهيكل بأوزان أثقل (RPE 7-8). يدخل الاندفاع مشيًا وتجديف "
        "البار ودفع الأرجل برجل واحدة والضغط المائل المنخفض. أضف وزنًا "
        "حيث كانت الجولة الأخيرة الأسبوع الماضي سلسة."),
    3: ("القوة الانفجارية",
        "أسبوع الذروة (RPE 8): سكوات أمامي وسحبات أثقل، صناديق أعلى، "
        "وثبات المتزلج وانطلاقات عند ٨٥٪. الجودة تحكم كل شيء — تمارين "
        "القوة تتوقف لحظة تباطؤ التكرارات."),
    4: ("الذروة + إعادة الاختبار",
        "الحجم ينخفض وتُجرى الاختبارات المرجعية: ثبات الحائط، سمانة "
        "برجل واحدة، البلانك، اتزان Y، القفز برجل واحدة — والجديد: أقصى "
        "عدد عقلات متقنة. تفوّق على أرقام الشهر الماضي وسجّلها كلها."),
}
