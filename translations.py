...
DAY_FOCUS_AR = {
    "Monday":    "قوة الأرجل والركبة — يوم ثقيل",
    "Tuesday":   "التوازن والثبات — الركبة والكتف",
    "Wednesday": "قوة الكتفين — يوم ثقيل",
    "Thursday":  "التوازن والتحكم — هبوط وردّات فعل",
    "Friday":    "يوم استشفاء",
...
WEEK_THEMES_AR = {
    1: ("التحميل",
        "يعود إيقاع الأخصائي: يوم قوة يليه يوم توازن. أيام القوة تبدأ "
        "عند RPE 7 بينما تحدد أوزان عملك؛ وأيام التوازن تبدأ على أرض "
        "ثابتة وعينين مفتوحتين — جودة التحكم هي النتيجة."),
    2: ("التقدم",
        "أيام القوة تصبح أثقل (RPE 7-8). أيام التوازن تتقدم بالتحدي لا "
        "بالوزن: ثبات بعينين مغمضتين، التفاتات الرأس، ومدّات أطول على "
        "رجل واحدة."),
    3: ("المتقدم",
        "أسبوع القوة الأعلى (RPE 8) — وأيام التوازن تصبح تفاعلية: رمي "
        "الكرة، الوقوف على وسادة، وهبوط أكبر مع التثبيت. التحكم يقرر "
        "كل تقدم."),
    4: ("الذروة + إعادة الاختبار",
        "الحجم ينخفض ويُقاس الجانبان: اختبارا ثبات الحائط والسمانة يوم "
        "الاثنين (قوة)؛ واتزان Y والقفز برجل واحدة والبلانك يوم الخميس "
        "(توازن). تفوّق على أرقامك السابقة."),
}
